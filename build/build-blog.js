 ...
 */
/** Same trick as cssVersion(): take the track.js version the pages already use,
 *  so the blog template cannot drift from the hand-written pages. */
function trackVersion() {
  try {
    const idx = fs.readFileSync(path.join(ROOT, 'index.html'), 'utf8');
    const m = idx.match(/track\.js\?v=(\d+)/);
    return m ? '?v=' + m[1] : '';
  } catch (e) {
    return '';
  }
...
<script src="../../assets/js/track.js${trackVersion()}"></script>
</body>
</html>
`;
}
